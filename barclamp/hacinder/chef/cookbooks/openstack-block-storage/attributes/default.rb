...
# Temporary Attributes for root db password data bags
override["openstack"]["developer_mode"] = false
override['openstack']['db']['root_user_use_databag'] = true
override['openstack']['db']['root_user_key'] = 'root_db_password'


# Database endpoint
# default["openstack"]["db"]["volume"]["host"] = "10.49.118.57"
...
#Cinder Endpoint (Keystone) --> Needs to be replaced with Cinder virtual ip address 
# default['openstack']['endpoints']['volume-api']['host'] = ipaddress 
# override keyword is used for Cinder "final" attributes. Those attributes are not meant to be set somewhere as they are related to Cinder component 
override['openstack']['endpoints']['volume-api']['scheme'] = "http"
override['openstack']['endpoints']['volume-api']['port'] = "8776"
override['openstack']['endpoints']['volume-api']['path'] = "/v1/%(tenant_id)s"

#Cinder db username --> "cinder" 
override["openstack"]["block-storage"]["db"]["username"] = "cinder"
